...
class FusionHead(nn.Module):
    ...
    def forward(self, cls_vit, cls_bert, return_proj=False):
        z_v = self.drop(self.ln_v(self.proj_v(cls_vit)))  # (B, d)
        z_t = self.drop(self.ln_t(self.proj_t(cls_bert)))  # (B, d)
